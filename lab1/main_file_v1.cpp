...
void myGlui()
{
	...
	glui1->add_button( "Refresh and Edit new point/Insert after a different point", REFRESH, refresh );
		...
		case GLUT_LEFT_BUTTON:
			switch (state)
			{
				case GLUT_DOWN:					
					...
					if(pointStat==1)// this means user wants to drag and edit points
					{
